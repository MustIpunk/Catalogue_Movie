package com.example.saiful.katalogmovie.adapter;
...
import com.example.saiful.katalogmovie.detail.TVShowDetailActivity;
...
public class TVShowAdapter extends RecyclerView.Adapter<TVShowAdapter.TVShowViewHolder> {
    ...
    public TVShowViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        View tvView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_tvshow, viewGroup, false);
